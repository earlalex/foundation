...
def run_cuj(page):
    ...
    if cms_tab.is_visible():
        ...
        page.screenshot(path=os.path.join(os.path.dirname(__file__), 'screenshots', 'cms_verification.png'))
        page.wait_for_timeout(1000)
    ...
    if products_tab.is_visible():
        ...
        page.screenshot(path=os.path.join(os.path.dirname(__file__), 'screenshots', 'products_verification.png'))
        page.wait_for_timeout(1000)
...
if __name__ == "__main__":
    ...
    for webm in glob.glob(os.path.join(os.path.dirname(__file__), 'videos', '*.webm')):
        try:
            os.remove(webm)
        except Exception:
            pass
