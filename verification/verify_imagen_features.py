...
def run_cuj(page):
    ...
    if cms_tab.is_visible():
        ...
        page.screenshot(path="verification/screenshots/cms_verification.png")
        page.wait_for_timeout(1000)
    ...
    if products_tab.is_visible():
        ...
        page.screenshot(path="verification/screenshots/products_verification.png")
        page.wait_for_timeout(1000)
...
if __name__ == "__main__":
    ...
    for webm in glob.glob("verification/videos/*.webm"):
        try:
            os.remove(webm)
        except Exception:
            pass
