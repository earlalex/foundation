...
def run_cuj(page):
    ...
    page.screenshot(path="/home/jules/verification/screenshots/homepage_feature_grid.png")
    ...
    page.screenshot(path="/home/jules/verification/screenshots/docs_crypto_payments.png")
