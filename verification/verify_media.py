...
def run_cuj(page):
    ...
    page.screenshot(path="verification/screenshots/gallery_page.png")
    page.wait_for_timeout(1000)
    ...
    if first_item.is_visible():
        first_item.click()
        page.wait_for_timeout(2000)
        page.screenshot(path="verification/screenshots/gallery_lightbox.png")
        page.wait_for_timeout(1000)
        # Close lightbox
    ...
    page.wait_for_timeout(2000)
    page.screenshot(path="verification/screenshots/videos_page.png")
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path="verification/screenshots/videos_page_played.png")
    page.wait_for_timeout(1000)
