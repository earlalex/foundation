...
def run_cuj(page):
    ...
    page.screenshot(path=os.path.join(os.path.dirname(__file__), 'screenshots', 'feature_toggles.png'))
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path=os.path.join(os.path.dirname(__file__), 'screenshots', 'cms_ai_generator.png'))
    page.wait_for_timeout(1000)
