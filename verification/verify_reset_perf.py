...
def run_cuj(page):
    ...
    if btn_exists:
        ...
        page.screenshot(path="/home/jules/verification/screenshots/reset_modal_step1.png")

        # Proceed to step 2
        print("Clicking next step...")
        page.click("#btn-reset-next")
        page.wait_for_timeout(2000)
        page.screenshot(path="/home/jules/verification/screenshots/reset_modal_step2.png")

        # Type verification phrase
        print("Typing verification phrase...")
        page.fill("#input-confirm-phrase", "RESET-FOUNDATION")
        page.wait_for_timeout(2000)
        page.screenshot(path="/home/jules/verification/screenshots/reset_modal_step2_typed.png")
