# verification/verify_screenshots.py
...
def run_cuj(page):
    ...
    page.screenshot(path="verification/screenshots/verification_home.png")
    ...
    page.wait_for_timeout(2000)
    page.screenshot(path="verification/screenshots/verification_admin.png")
