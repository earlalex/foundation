...
def run_cuj(page, context):
    ...
    page.screenshot(path=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'screenshots', 'verify_contact_page.png'))
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'screenshots', 'verify_admin_configurator.png'))
    page.wait_for_timeout(1000)
