...
export class HeroBanner extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      <section class="hero-banner" style="padding: 5rem 2rem; text-align: center; background: linear-gradient(135deg, var(--theme-color-background, #f7fafc) 0%, var(--theme-color-surface, #ffffff) 100%); font-family: var(--theme-font-font-family, system-ui, sans-serif); border-bottom: 1px solid var(--theme-color-border, #edf2f7);">
